...
- CI runs axe on every built page in both themes (`npm run test:e2e`, ADR-0011). This audit covers what axe cannot: keyboard, focus order, reading order, no-JS content, and layout.
