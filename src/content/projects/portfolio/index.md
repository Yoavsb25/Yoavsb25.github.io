...
built:
  ...
  - Automatic guardrails that stop leaked passwords, broken code, and risky changes before they are saved.
  - AI assistants set up with clear rules, so they work like a careful teammate.
