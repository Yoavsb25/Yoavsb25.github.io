...
- **CI**: `verify`, `audit`, `actionlint`, `codeql`, `e2e` (Playwright + axe in both themes, byte budgets; ADR-0011), `lighthouse` (ADR-0012), and `links` (internal, offline; ADR-0013) on every PR. External links weekly (`links.yml`).
