...
| 7   | `feat/design-system`           | Tokens, fonts, `ui/` primitives, layout shell (Header, Footer, BaseLayout)                                       | ⏳             |
...
| 10  | `feat/content-model`           | Content collections + schemas, `/new-case-study`, `/sync-projects`                                               | ⏳             |
| 11  | `feat/seo`                     | SEO/JSON-LD, CSP, OG images, sitemap, robots, `llms.txt`                                                         | ⏳             |
| 12  | `feat/pages`                   | Home (hero, how I work, work, resume, contact), case study pages, 404                                            | ⏳             |
