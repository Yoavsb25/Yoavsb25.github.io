...
| Risk                                | Mitigation                                                                                                                                                          |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Compromised dependency              | Dependabot, `npm run audit` gate in CI, lockfile committed, `npm ci` only, lockfile-sync pre-commit check; Lighthouse runs from a SHA-pinned action (ADR-0012)      |
